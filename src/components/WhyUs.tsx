            ...
            >
              <div className="flex items-start space-x-4 md:space-x-6">
                <div className="flex-shrink-0">
                  <div className="p-3 md:p-4 bg-gradient-primary rounded-2xl md:rounded-3xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                    <highlight.icon className="w-6 h-6 md:w-8 md:h-8 text-primary-foreground" />
                  </div>
                </div>
          ...
          {impactStats.map((stat, index) => (
            ...
            >
              <div className="glass-card hover:shadow-elevated hover:glow-accent transition-all duration-500 transform hover:-translate-y-2">
                <div className="inline-flex p-3 md:p-4 bg-gradient-primary rounded-2xl md:rounded-3xl mb-4 md:mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
